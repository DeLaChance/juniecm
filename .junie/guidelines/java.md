...
-   **Guideline:** Prefer using builders for classes, by using `@Builder` from Lombok.
- **Guideline**: Do not use records.  
- **Example:**
...
- Use Lombok with annotations `@Getter` and `@Builder` to create this.
